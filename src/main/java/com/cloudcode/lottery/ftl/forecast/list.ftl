...
$( "#edit" ).click(function(){
	window.location.href='${request.getContextPath()}/forecast/toCalcSearch?issueid=${issueid!''}';
}); 
...
var id;
	     ...
	     if(id.toString() != null && id.toString() != ""){
		    $.ajax({
			        url: '${request.getContextPath()}/forecast/'+id+'/delete',
			        type: 'post',
			        dataType: 'json',
	...
	$( "#refresh" ).click(function(){
	 ...
	 $( "#export" ).click(function(){
			ajaxframework.postForm('${request.getContextPath()}/forecast/export',null,null)
	});
}); 
</script>
